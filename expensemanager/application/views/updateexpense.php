    ...
    function validateexpense(event)
    {
      ...
      var x = new Date(document.getElementById('customdate').value);
       ...
       if(x>y)
       {
        ...
        document.getElementById("upexpense").action="updateexpense?e_id=<?php echo $exp_id?>";
...
<div id="MiddleBar" class="row"  style="margin-top:1.9em;border-radius:15px;word-wrap: break-word;" >
  ...
  <div   class="row"  >
                    ...
                    <div id="amountEntry"  class="col-md-6 " style="margin-top:2%;height:2em;margin-bottom:4%">
                        ...
                        <div class="text-center"style="float:left;width:50%;margin-left:20%;margin-right:10%">
                                <input  class="form-control text-center" id="price" name="price" style="width:100%"  id="focusedInput" type="number" step="0.01" min="0.01" placeholder="0.00" required value="<?php echo $price?>"> 
                        </div>
         ...
         <div id="acceptTags" required class="col-md-6 " style="margin-bottom:4%;margin-top:2%;">
             <input class="form-control"  name="tag" id="focusedInput" type="text" placeholder="Tap to Add Tags" required value="<?php echo $tag?>">
    ...
    <div id="Tabs" style="margin-bottom:4%;font-size:0.8em;font-weight:bold">     
        ...
        <div style="width:90%">
            <textarea class="form-control" name="description" rows="6" id="comment" placeholder="Description.." style="width:110%;margin-left:1em"><?php echo $description?> </textarea>
