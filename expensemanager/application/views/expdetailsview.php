...
<div id="TopBar" class="row text-center">
 ...
 <!--Remaining View Starts here -->
  ...
  <div id="MiddleBar" class="row" style="word-wrap: break-word;">
      <div class="row"> 
          <div id="amountEntry" class="col-md-6 text-center" style="margin-top:2%;height:2em;margin-bottom:4%">   
              <div  style="float:left;width:100%;">     
                  <label   class=" text-center" style="width:100%" id="focusedInput"   >Price:- <i class="fa fa-inr"></i> <?php echo $price?>  </label>
              </div> 
...
<div id="BottomBar" class="row text-center">
    <div class="text-center myborder " style="cursor:pointer;height:1.4em;width:33.33%;float:left;z-index: 8;background: #FFFFCC; opacity: 1"
    ...
    <div class="text-center myborder" style="cursor:pointer;height:1.4em;width:33.33%;float:left;z-index: 8;background: #FFFFCC;">
        <span class="glyphicon glyphicon-home" style="color:red;border-radius: 25px;" onclick="location.href='<?php echo site_url('customerhomecontroller'); ?>',checker=0"></span>
    </div>
    
    <div class="text-center myborder" style="cursor:pointer;height:1.4em;width:33.33%;float:left;z-index: 8;background: #FFFFCC; ;opacity: 1" onclick="location.href='<?php echo site_url("addexpensecontroller/displayupdateview?e_id=$exp_id"); ?>',checker=0">
